...
class Settings(BaseSettings):
    ...
    TP_PERCENTAGE: float = Field(default=10, ge=0.0)
    
    TP_ROI_PERCENTAGE_1: float = Field(default=5, ge=0.0)
    TP_ROI_PERCENTAGE_2: float = Field(default=10, ge=0.0)  
    TP_ROI_PERCENTAGE_3: float = Field(default=20, ge=0.0)      
    TP_QTY_PERCENTAGE_1: float = Field(default=25, ge=0.0, le=100.0)
    TP_QTY_PERCENTAGE_2: float = Field(default=50, ge=0.0, le=100.0)
    TP_QTY_PERCENTAGE_3: float = Field(default=0, ge=0.0, le=100.0)
    
    SL_PERCENTAGE: float = Field(default=10, ge=0.0)
    SL_BREAKEVEN_PERCENTAGE: float = Field(default=50, ge=0.0, le=100.0)
    TP_AMOUNT: float = Field(default=0, ge=0.0)
    SL_AMOUNT: float = Field(default=5.0, ge=0.0)
