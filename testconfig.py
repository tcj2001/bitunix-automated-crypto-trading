...
class Settings(BaseSettings):
    ...
    @validator('api_key', 'secret_key', 'SECRET', 'password', pre=True)
...
if __name__ == "__main__":
    ...
    settings = Settings()
    print(f"Settings 1 API Key: {settings.api_key.get_secret_value()}")
    print(f"Settings 1 Auto Trade: {settings.autoTrade}")
    print(f"Settings 1 Leverage: {settings.leverage}")
    
    set_key(".env", "autoTrade", "False")

    settings = Settings()
    print(f"Settings 2 API Key: {settings.api_key.get_secret_value()}")
    print(f"Settings 2 Auto Trade: {settings.autoTrade}")
    print(f"Settings 2 Leverage: {settings.leverage}")
